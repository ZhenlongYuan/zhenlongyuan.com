...
- `Preprint` [Pure Vision Language Action (VLA) Models: A Comprehensive Survey] D Zhang, J Sun, C Hu, X Wu, **Z Yuan**, et al.
- AutoDrive-R2: Incentivizing Reasoning and Self-Reflection Capacity for VLA Model in Autonomous Driving. **Z Yuan**, J Tang, J Luo, et al. 
